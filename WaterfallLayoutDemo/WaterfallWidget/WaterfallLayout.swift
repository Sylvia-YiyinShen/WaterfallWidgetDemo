...
public enum WaterfallLayoutItemRenderDirection: Int {
    case WaterfallLayoutItemRenderDirectionShortestFirst
    case WaterfallLayoutItemRenderDirectionLeftToRight
    case WaterfallLayoutItemRenderDirectionRightToLeft
}

//public  let SectionHeader = "CHTCollectionElementKindSectionHeader"
//public  let SectionFooter = "CHTCollectionElementKindSectionFooter"
...
public class WaterfallLayout: UICollectionViewLayout {
    ...
    override public init() {
        ...
        self.itemRenderDirection =
            WaterfallLayoutItemRenderDirection.WaterfallLayoutItemRenderDirectionShortestFirst
        unionRects = []
        columnHeights = []
        allItemAttributes = []
